...
if __name__ == '__main__':
    ...
    matchHead = u.create_file_head(SOURCE_FILE, 'right', [LABEL_FILE.split('.')[0]])
    ...
    u.writeDictFile(u.changeFileName(combinefileName(SOURCE_FILE, LABEL_FILE), '统计.csv'), keyWordCount, 1)
